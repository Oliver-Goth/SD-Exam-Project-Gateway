...
public class FulfillmentApplicationService implements CreateFulfillmentFromOrderUseCase, MarkFulfillmentPreparedUseCase {
    ...
    @Override
    public FulfillmentOrder createFromOrder(Long orderId,
                                            Long restaurantId,
                                            Long customerId,
                                            PreparationDetails preparationDetails,
                                            KitchenNote kitchenNote) {
        FulfillmentOrder order = new FulfillmentOrder(orderId, restaurantId, customerId, preparationDetails, kitchenNote);
